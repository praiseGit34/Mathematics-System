...
public class Email {
    ...
    String username = "praiseasiimire38@gmail.com";
    String from = "praiseasiimire38@gmail.com";
    String password = "xoyn gpbx udrz espd";
    Session session;
    ...
    public void sendRepEmailNotification(String to, String participantEmail, String username) throws MessagingException {
    ...
    public void sendEmailNotification(String to, String participantName, String school) throws MessagingException {
        MimeMessage message = new MimeMessage(this.session);
